...
export const FRAMES = [
  ...
  // Özel
  { name: 'Nova', rarity: RARITIES.ÖZEL.name, className: 'frame-nova-stars p-1 bg-gradient-to-tr from-purple-500 via-indigo-700 to-fuchsia-500 rounded-full shadow-[0_0_20px_theme(colors.purple.400)] animate-pulse' },
];