...
const githubLinks = [
  ...
  { url: "https://github.com/CodeNova5566", label: "CodeNova5566 GitHub" },
  { url: "https://github.com/Qptimuss", label: "Qptimuss GitHub" },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-5 py-20 text-center">
      <div className="max-w-4xl">
        ...
        <div className="mt-10">
          <h2 className="text-foreground text-2xl font-outfit font-bold mb-4">Proje Bağlantıları</h2>
