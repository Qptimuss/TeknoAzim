  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-5 py-20 text-center">
      <div className="max-w-2xl">
        ...
        <p className="text-muted-foreground text-xl md:text-2xl font-roboto font-normal mb-8">
          Bu sayfa henüz hazırlanıyor. İçerik yakında eklenecektir.
        </p>
        <Link
          to="/"
          className="inline-block rounded-full bg-card border border-border px-12 py-4 font-roboto text-xl text-foreground hover:bg-accent transition-colors"
        >
          Ana Sayfaya Dön
        </Link>
      </div>
