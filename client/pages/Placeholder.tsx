...
export default function Placeholder({ title }: PlaceholderProps) {
  ...
  return (
    <div className="bg-[#020303] min-h-screen">
      {/* Navigation Bar */}
      <nav className="sticky top-0 z-50 w-full max-w-[1122px] mx-auto rounded-[40px] bg-[#e6e6e6] border-2 border-[#2a2d31] p-1 md:p-2 pt-14 pb-8 px-5 md:px-10 lg:px-20">
