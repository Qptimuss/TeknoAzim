...
const selectRandomFrame = () => {
  // Test için geçici olarak her zaman Nova çerçevesini döndür
  const novaFrame = FRAMES.find(frame => frame.name === 'Nova');
  if (novaFrame) {
    return novaFrame;
  }
  // Nova bulunamazsa varsayılan olarak ilk çerçeveyi döndür
  return FRAMES[0];
};
