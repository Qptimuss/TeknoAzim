        ...
        <div className="relative z-10 px-5 md:px-10 lg:px-20 pb-8 flex flex-col items-center pt-32">
          <div className="w-full max-w-[1122px]">
            ...
            <div className="flex justify-center mt-8 md:mt-10">
              <Link
                to="/kaydol"
                className="rounded-full border-4 border-white px-16 md:px-20 lg:px-24 py-5 md:py-6 font-roboto text-2xl md:text-3xl text-foreground hover:bg-accent transition-colors text-center"
              >
                Başla
              </Link>
            </div>
