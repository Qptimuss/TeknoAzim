  ...
  return (
    <>
      ...
      <section className="relative min-h-[960px] w-full -mt-28">
        ...
        <div className="absolute inset-0 h-full w-full bg-gradient-to-t from-background via-background/70 to-background/40" />
        ...
        <div className="relative z-10 px-5 md:px-10 lg:px-20 pb-8 flex flex-col items-center pt-32">
          <div className="w-full max-w-[1122px]">
            {/* Hero Content */}
            <h1 className="text-foreground text-3xl md:text-4xl lg:text-5xl font-outfit font-bold text-center mt-12 md:mt-16 lg:mt-20 px-4">
              Düşüncelerle derinleşen,yazılarla genişleyen bir dünya.
            </h1>

            <p className="text-muted-foreground text-lg md:text-2xl lg:text-[25px] font-roboto font-normal text-center mt-6 md:mt-8 px-4">
            ...
            <div className="flex justify-center mt-8 md:mt-10">
              <Link
                to="/kaydol"
                className="rounded-full bg-background/20 backdrop-blur-sm border border-border px-16 md:px-20 lg:px-24 py-5 md:py-6 font-roboto text-2xl md:text-3xl text-foreground hover:bg-accent transition-colors text-center"
              >
                Başla
              </Link>
            </div>
